...
class FakeWalletAppHarnessTest {
    ...
    fun fakeWalletShellNavigatesTabsAndPushedRoutesWithoutRealServices() {
        ...
        compose.onNodeWithText("Fake Mint").assertIsDisplayed()
        compose.onNodeWithText("Fake Mint").performClick()
    ...
    fun fakeWalletShellCoversSendReceiveSettingsAndOverlays() {
        ...
        compose.onNodeWithText("P2PK and token generation").assertIsDisplayed()
        compose.onNodeWithContentDescription("Back").performClick()
        compose.onNodeWithContentDescription("Back").performClick()
        ...
        compose.onNodeWithText("Invoice, reusable invoice, and on-chain").assertIsDisplayed()
        compose.onNodeWithContentDescription("Back").performClick()
        ...
        compose.onNodeWithText("Seed reveal and restore entry").assertIsDisplayed()
        compose.onNodeWithContentDescription("Back").performClick()
        compose.onNodeWithText("Nostr").performClick()
        compose.onNodeWithText("Signer and relays").assertIsDisplayed()
        compose.onNodeWithContentDescription("Back").performClick()
